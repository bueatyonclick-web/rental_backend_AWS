...
from backend.models import User, Category, Slide, Product, ProductOption, ProductImage, PageItem, OrderedProduct, \
    Notification, ContactInfo, InformMe, AppVersion, ServiceImage, ServiceOption, ServiceCategory, Service, \
    ServicePageItem, ServiceBooking
...
class ServiceCategorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'name', 'position', 'image', 'icon', 'color']
...
class ServiceBookingSerializer(serializers.ModelSerializer):
    ...
    service_image = serializers.SerializerMethodField()  # ADD THIS

    class Meta:
        model = ServiceBooking
        fields = [
            'id', 'service_name', 'option_name', 'provider_name',
    ...
    def get_service_image(self, obj):  # ADD THIS METHOD
